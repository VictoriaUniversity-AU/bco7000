...
1. Create (=clone a repository) a separate R Project for the assignment and call it “Practical assignment”. Please store all your files there.
...
1. Create an Rmarkdown document with webpage as output
...
Explaiin your choice of variables (3 sentences) 
